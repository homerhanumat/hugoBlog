...
Now suppose that the value of the parameter `n` is 10.  Then by the time you get to making the graph you'll have the terms:
...
The natural way to accomplish the above task is to use a `for`-loop in whihc we iterate by index and store results.  The outline of such a loop is:
